...
지금 바로 시작해볼까요?`,
    ...
    const { data: allQuestions, error: fetchError } = await supabase
      .from('chat_questions')
      .select('order_index, type, is_active, question')
