...
const testCases = [
  ...
  { phone: '010 1234 5678', expected: 'success' },
  { phone: '011-1234-5678', expected: 'success' },
  { phone: '016-1234-5678', expected: 'success' },
  { phone: '017-1234-5678', expected: 'success' },
  { phone: '018-1234-5678', expected: 'success' },
  { phone: '019-1234-5678', expected: 'success' },
